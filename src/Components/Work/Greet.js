...
import photo from '../../images/jaron.PNG'
        ...
        <div className="greet-page">
            ...
            <Container>
                <Row id="main-section">
                    ...
                    <Col md={8} lg={6}>
                        ...
                        <Row id="center-mid">
                            ...
                            <Col xs={2} lg={2}>
                                <a href="https://github.com/Jaron-Lane" target="_blank" rel="noreferrer">
                ...
                <Row id="sub-section">
                    ...
                    <Col lg={8}>
                        <h2 id="greet-sub-titles">“We're all rough drafts of the people we're still becoming” -Bob Goff</h2>
                    </Col>
                </Row>
                {/* <Row id="sub-section">
                    <Col lg={8}>
